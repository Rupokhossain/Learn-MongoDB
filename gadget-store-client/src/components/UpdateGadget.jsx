...
const UpdateGadget = () => {
  ...
  const handleUpdate = (e) => {
    ...
    const updatedGadget = Object.fromEntries(formData.entries());
    console.log(updatedGadget);

    // send updated gadget to the db
    fetch(`http://localhost:5000/gadgets/${_id}`, {
      method: "PUT",
       headers: {
        "content-type": "application/json",
      },
      body: JSON.stringify(updatedGadget),
    })
    .then((res) => res.json())
    .then((data) => {
      console.log(data);
